...
<body>
    ...
    <section class="bg-light mt-2 mb-1 pb-1">
        ...
        <div class="form-group align-items-center">
            <div class="card-body px-0">            
                <textarea maxlength="30000" class="composeBox-textArea form-control @error('body') is-invalid @enderror" id="messaging-text"
                placeholder="Responder ao topico…" style="overflow: hidden; overflow-wrap: break-word; height: 50px; width: 100%; ">{{old('body')}}</textarea>
